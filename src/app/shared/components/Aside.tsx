...
export const Aside = () => {
  ...
  return (
    <aside className="row-span-2 border-2 border-black p-4">
      <div className="">
        <Image
      ...
      <section>
        <a
          className="relative block mx-auto my-6 py-2 text-center border border-[rgba(0,0,0,0.616)] backdrop-blur-[.5rem] bg-transparent cursor-pointer z-10 overflow-hidden rounded-lg shadow-[0_0_.5rem_rgba(0,0,0,0.132)] transition-all duration-500 text-lg font-semibold"
          href="#"
